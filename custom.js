...
<div class="manually-added-home-widgets section" id="tgpromo" style="margin-bottom: 14px; margin-top: 14px;">
  ...
  <div class="container" id="floating-payment" style="position: relative;">
    ...
    <img
      ...
      "
    />
    <a href="https://betredi122.com/${language}/promotion/1000000tl-cekim-imkani" id="payment-details-btn" style="display flex !important; align-items: center !important; justify-content: center !important; position: absolute; bottom: 10%; right: 7%; background: #630306; padding: 8px 10px; border-radius: 6px; z-index: 10; gap: 2px;">
